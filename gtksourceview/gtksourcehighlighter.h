...
#define GTK_TYPE_SOURCE_HIGHLIGHTER            (gtk_source_highlighter_get_type ())
...
GType		 	gtk_source_highlighter_get_type	 (void) G_GNUC_CONST;

GtkSourceHighlighter * 	gtk_source_highlighter_new 		 (GtkSourceContextEngine *engine);
void 			gtk_source_highlighter_set_style_scheme  (GtkSourceHighlighter   *highlighter,
				       				  GtkSourceStyleScheme   *scheme);
void 			gtk_source_highlighter_set_styles_map	 (GtkSourceHighlighter   *highlighter,
				       				  GHashTable 	         *styles);
void			gtk_source_highlighter_attach_buffer 	 (GtkSourceHighlighter   *highlighter,
								  GtkTextBuffer          *buffer,
								  Segment	         *root_segment);
void			gtk_source_highlighter_ensure_highlight  (GtkSourceHighlighter   *highlighter,
								  const GtkTextIter      *start,
								  const GtkTextIter      *end);
void			gtk_source_highlighter_invalidate_region (GtkSourceHighlighter *highlighter,
			                                          const GtkTextIter *start,
			                                          const GtkTextIter *end);
GtkTextTag *		gtk_source_highlighter_get_tag_for_style (GtkSourceHighlighter *highlighter,
								  const gchar          *style,
